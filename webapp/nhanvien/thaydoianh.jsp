...
<body>
	...
	<%
		...
		String duongDanAnh= nhanVien.getDuongDanAnh();
	...
	<div class="container">
		...
		<%
		 ...
		 %>
		<form class="form" action="<%=url1 %>/nhan-vien-thay-doi-anh" method="post" enctype="multipart/form-data"><!--bỏ hình ảnh vô phải có multipart  -->
				...
				<div class="col-sm-6">
					...
					<div class="mb-3">
						<label for="duongDanAnh" class="form-label">Đường dẫn ảnh</label> <input
							type="file" class="form-control" id="duongDanAnh" name="duongDanAnh"><!--update file lên-->
					</div>
